...
BASE_COLOR_TABLE = [
    ...
    # normal
    ColorEntry(QtGui.QColor(0x00,0x00,0x00), 0, 0 ), ColorEntry( QtGui.QColor(0xB2,0xB2,0xB2), 1, 0 ), # Dfore, Dback
    ColorEntry(QtGui.QColor(0x00,0x00,0x00), 0, 0 ), ColorEntry( QtGui.QColor(0xB2,0x18,0x18), 0, 0 ), # Black, Red
    ColorEntry(QtGui.QColor(0x18,0xB2,0x18), 0, 0 ), ColorEntry( QtGui.QColor(0xB2,0x68,0x18), 0, 0 ), # Green, Yellow
    ColorEntry(QtGui.QColor(0x18,0x18,0xB2), 0, 0 ), ColorEntry( QtGui.QColor(0xB2,0x18,0xB2), 0, 0 ), # Blue,  Magenta
    ColorEntry(QtGui.QColor(0x18,0xB2,0xB2), 0, 0 ), ColorEntry( QtGui.QColor(0xB2,0xB2,0xB2), 0, 0 ), # Cyan,  White
    # intensiv
    ColorEntry(QtGui.QColor(0x00,0x00,0x00), 0, 1 ), ColorEntry( QtGui.QColor(0xFF,0xFF,0xFF), 1, 0 ),
    ColorEntry(QtGui.QColor(0x68,0x68,0x68), 0, 0 ), ColorEntry( QtGui.QColor(0xFF,0x54,0x54), 0, 0 ),
    ColorEntry(QtGui.QColor(0x54,0xFF,0x54), 0, 0 ), ColorEntry( QtGui.QColor(0xFF,0xFF,0x54), 0, 0 ),
    ColorEntry(QtGui.QColor(0x54,0x54,0xFF), 0, 0 ), ColorEntry( QtGui.QColor(0xFF,0x54,0xFF), 0, 0 ),
    ColorEntry(QtGui.QColor(0x54,0xFF,0xFF), 0, 0 ), ColorEntry( QtGui.QColor(0xFF,0xFF,0xFF), 0, 0 )
]
...
class ShellWidget(signalable.Signalable, QtGui.QFrame):
...
##         self._qapp.removeEventFilter( self )
    ...
    def setImage(self, newimg, lines, columns):
        ...
        if self.resizing and self.terminal_size_hint:
            ...
            if not self.m_resize_widget:
                self.m_resize_widget = QtGui.QFrame(self)
    ...
    def eventFilter(self, obj, e):
        ...
        return QtGui.QFrame.eventFilter(self, obj, e)
