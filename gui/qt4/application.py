...
try:
    ...
    print "[-] Python QT4 was not found in the system, please install it and try again"
    print "Check the deps file"

from gui.gui_app import FaradayUi
from gui.qt4.mainwindow import MainWindow
from gui.qt4.customevents import QtCustomEvent
